...
const Question = () => {
  return (
    <div className="slide a-1">
      ...
      <form>
        <input type="radio" name="quiz" value="1" />1. Because cooking releases
        water from the food, and we want the water to leave the pan quickly.<br />
        <input type="radio" name="quiz" value="2" />2. Because the water
        molecule keeps the food hot for a while.<br />
        <input type="radio" name="quiz" value="3" />3. Because otherwise the pan
        won't conduct heat.<br />
